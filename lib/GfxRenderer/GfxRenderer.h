...
class GfxRenderer {
 ...
 public:
  ...
  void clearFontCache();  // Implemented in GfxRenderer.cpp
  ...
  int getTextAdvanceX(int fontId, const char* text, EpdFontFamily::Style style, uint32_t trailingNextCp = 0) const;
  int getFontAscenderSize(int fontId) const;
  int getFontEmHeight(int fontId) const;
  ...
  void drawTextRotated90CW(int fontId, int x, int y, const char* text, bool black = true,
                           EpdFontFamily::Style style = EpdFontFamily::REGULAR) const;
  // Helper for drawing rotated text (90 degrees counter-clockwise, for vertical opening brackets)
